    ...
    public class ImageSharpCubemapTexture
    {
        ...
        public Texture CreateDeviceTexture(GraphicsDevice gd, ResourceFactory factory)
        {
            ...
            for (int level = 0; level < MipLevels; level++)
            {
                ...
                gd.UpdateTexture<Rgba32>(cubemapTexture, pixelSpanPosX.ToArray(), 0, 0, 0, Width, Height, 1, (uint)level, PositiveXArrayLayer);
                gd.UpdateTexture<Rgba32>(cubemapTexture, pixelSpanNegX.ToArray(), 0, 0, 0, Width, Height, 1, (uint)level, NegativeXArrayLayer);
                gd.UpdateTexture<Rgba32>(cubemapTexture, pixelSpanPosY.ToArray(), 0, 0, 0, Width, Height, 1, (uint)level, PositiveYArrayLayer);
                gd.UpdateTexture<Rgba32>(cubemapTexture, pixelSpanNegY.ToArray(), 0, 0, 0, Width, Height, 1, (uint)level, NegativeYArrayLayer);
                gd.UpdateTexture<Rgba32>(cubemapTexture, pixelSpanPosZ.ToArray(), 0, 0, 0, Width, Height, 1, (uint)level, PositiveZArrayLayer);
                gd.UpdateTexture<Rgba32>(cubemapTexture, pixelSpanNegZ.ToArray(), 0, 0, 0, Width, Height, 1, (uint)level, NegativeZArrayLayer);
            }
